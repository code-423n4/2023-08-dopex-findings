...
| :--------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------- | --------: |
| [L-01](#l-01---missing-validation-for-address0-in-the-constructors-or-in-the-functions-changing-state-variables) | Missing validation for `address(0)` in the constructors or in the functions changing state variables. |           |
| [L-02](#l-02---use-proper-error-message-with-contract-location-trace)                                            | Use proper `error` message with contract location trace                                               |           |
| [L-03](#l-03---hardcoded-address-will-do-issue-while-using-the-code-on-multiple-networks)                        | `hardcoded` address will do issue while using the code on multiple networks                           |           |
| [L-04](#l-04---typo-in-the-validation-of-addresses)                                                              | Typo in the validation of addresses                                                                   |           |
...
| Number                                                                                                                                       | Issue                                                                                                                             | Instances |
| :------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------- | --------- |
| [N-01](#n-01---use-natspec-comments-for-events-state-variables-constructor-functions-and-all-other-things-which-will-be-included-in-the-abi) | Use `Natspec` comments for events, state variables, constructor, functions and all other things which will be included in the ABI |           |
| [N-02](#n-02---set-the-internal-layout-of-contracts-interfaces-and-libraries)                                                                | Set the Internal Layout of Contracts, Interfaces, and Libraries                                                                   |           |
| [N-03](#n-03---safemath-library-is-not-needed-for-versions-greater-than-or-equal-to-080)                                                     | `SafeMath` library is not needed for versions greater than or equal to `0.8.0`                                                    |           |
| [N-04](#n-04---use-natspec-comments-for-smart-contracts-interfaces-and-libraries)                                                            | Use `Natspec` comments for smart contracts, interfaces and libraries                                                              |           |
| [N-05](#n-05---variables-should-follow-the-naming-convention)                                                                                | Variables should follow the naming convention                                                                                     |           |
| [N-06](#n-06---unnecessary-check-for-minter_role)                                                                                            | Unnecessary Check for `MINTER_ROLE`                                                                                               |           |
| [N-07](#n-07---unnecessary-imports)                                                                                                          | Unnecessary Imports                                                                                                               |           |
| [N-08](#n-08---developers-forgot-to-expain-these-comments)                                                                                   | Developers forgot to expain these comments                                                                                        |           |
| [N-09](#n-09---internal-functions-and-variables-should-follow-the-convention)                                                                | Internal functions and variables should follow the convention                                                                     |           |
